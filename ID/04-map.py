...
data_frame = pd.read_csv(input_filename, encoding='gb18030',
                         low_memory=False, names=['省', '总计', '男', '女',
                                                  'S90', 'S80', 'S70', 'S60', 'S50',
                                                  'S40', 'S30', 'S20', 'Sxx'])
sheng = data_frame.省
...
Mymap = Map('地图分布图', width=1200, height=600)
Mymap.add('',
          data_list_sheng,
          data_list_human,
          maptype='china',
          ...
          is_label_show=True)
Mymap.render(''.join(output_path + 'map.html'))

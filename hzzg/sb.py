...
class ShengBao:
    ...
    def value12(self):
        ...
        for text in ckrlb:
            ...
            #没有id 好难定位啊,真丑
            #存款人类别
            Select(self.driver.find_element_by_xpath('//*[@id="form-busi_12"]/div[3]/div[2]/div/select')).select_by_value(text)
            # for zz in zjzl:
            #证件种类
            Select(self.driver.find_element_by_xpath('//*[@id="form-busi_12"]/div[5]/div[2]/div/select')).select_by_value('02004')
            #行业类别
            Select(self.driver.find_element_by_xpath('//*[@id="form-busi_12"]/div[6]/div[2]/div/select')).select_by_value('H')
            #负责人种类
            Select(self.driver.find_element_by_xpath('//*[@id="form-busi_12"]/div[7]/div[2]/div/select')).select_by_value('01003')
            #地区代码
            Select(self.driver.find_element_by_xpath('//*[@id="form-busi_12"]/div[9]/div[1]/div/select')).select_by_value('330000')
            #账户
